    ...
    <div className="container">
      <div className="mt-5 mb-5">
        ...
        <p>
          ...
          long-lasting relationships with our customers by ensuring satisfaction
          with every purchase.
        </p>
        <p>
          With a user-friendly interface and secure payment options, shopping
          with us is convenient and worry-free. Our dedicated team is committed
          to delivering your orders promptly and addressing any inquiries or
          concerns promptly.
        </p>
        <p>
          Thank you for choosing <strong>QuickPick.</strong> We appreciate your
